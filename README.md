...
<div align="center">
  ...
  <br>
  <img src="https://img.shields.io/badge/Spring_Boot-A78BFA?style=for-the-badge&logo=springboot&logoColor=white" />
  ...
  <br>
  <img src="https://img.shields.io/badge/LangChain-A78BFA?style=for-the-badge&logo=langchain&logoColor=white" />
...
<div align="center">
  ...
  <img src="https://github-readme-streak-stats.herokuapp.com/?user=print-ramcharan&hide_border=true&background=ffffff&ring=a855f7&fire=a855f7&currStreakLabel=4b5563&currStreakNum=a855f7&sideNums=a855f7&sideLabels=4b5563" />
  <br><br>
...
<div align="center">
  ...
  <table width="100%">
    <thead>
      <tr>
        <th align="left" width="25%">Project / System</th>
        <th align="left" width="55%">Architectural Focus & Impact</th>
        <th align="left" width="20%">Core Stack</th>
      </tr>
    </thead>
    <tbody>
      <tr>
        <td><b>Gandharva: Music Application</b></td>
        <td>High-fidelity, free music streaming platform featuring a multi-source smart-link resolution engine, local SQLite track caching, and real-time social listening sync.</td>
        <td><code>TypeScript</code> <code>React Native</code> <code>Supabase</code> <code>SQLite</code> <code>Expo</code></td>
      </tr>
      <tr>
        <td><b>Zentra: Distributed Order Management</b></td>
        <td>High-throughput, event-driven microservices architecture utilizing Kafka for decoupled orchestration, optimized caching, and horizontal scalability.</td>
        <td><code>Java</code> <code>Spring Boot</code> <code>Kafka</code> <code>Redis</code> <code>Docker</code></td>
      </tr>
      <tr>
        <td><b>Secret Chat App</b></td>
        <td>Native Android instant messaging platform utilizing dual-channel WebSockets for asynchronous events, foreground message synchronization services, and local state management.</td>
        <td><code>Kotlin</code> <code>Jetpack Compose</code> <code>WebSockets</code> <code>MVVM</code> <code>FCM</code></td>
      </tr>
      <tr>
        <td><b>Context Rot Mitigation AI Pipeline</b></td>
        <td>Hybrid search architecture and external memory execution layer engineered to mitigate LLM context degradation under strict resource constraints.</td>
        <td><code>Python</code> <code>Vector DBs</code> <code>RAG</code> <code>Hybrid Search</code></td>
      </tr>
      <tr>
        <td><b>Real-Time Fraud Detection Platform</b></td>
        <td>Multi-agent data streaming platform executing complex evaluation rules and processing high-velocity data feeds under strict latency limits.</td>
        <td><code>Python</code> <code>Kafka</code> <code>FastAPI</code> <code>PostgreSQL</code></td>
      </tr>
    </tbody>
  </table>
  <br>
...
<div align="center">
  ...
  <table width="100%">
    <thead>
      <tr>
        <th align="left" width="25%">Domain Focus</th>
        <th align="left" width="40%">Core Target Track</th>
        <th align="left" width="35%">Real-Time State</th>
      </tr>
    </thead>
    <tbody>
      <tr>
        <td><b>Distributed Scaling</b></td>
        <td><code>Apache Kafka</code> • <code>Microservices</code></td>
        <td>Optimizing message delivery systems.</td>
      </tr>
      <tr>
        <td><b>Intelligence Fusion</b></td>
        <td><code>Multi-Agent AI</code> • <code>LLM Orchestration</code></td>
        <td>Designing high-performance RAG workflows.</td>
      </tr>
      <tr>
        <td><b>Cluster Management</b></td>
        <td><code>Kubernetes</code> • <code>Docker Runtimes</code></td>
        <td>Orchestrating decoupled infrastructure.</td>
      </tr>
    </tbody>
  </table>
  <br>
